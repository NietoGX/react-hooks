...
Elaborate on your learnings here in `src/exercise/03.md` The file 03.js contains
the solution to the extra-exercise. The exercise 03 is using the state for name
in the App component instead of the Name state and show the name to in the
Display component.
